...
export const servicePageContentBySlug: Record<string, ServicePageContentOverride> = {
  "electrical-plumbing": {
    detailDescriptionEn:
      "If you are searching for an electrician in Kannur, plumber in Kannur, electrician in Panoor, or plumbing services near me, Ithihasam provides doorstep support for houses, flats, villas, shops, and offices across Kannur district. We handle house wiring, switchboard repair, MCB tripping, motor connection, pipe leakage repair, tap replacement, bathroom fitting work, tank plumbing, and emergency electrical or plumbing maintenance with fast local scheduling.",
    faqsEn: [
      {
        q: "Do you provide electrician and plumber service across Kannur district?",
        a: "Yes. We cover core areas such as Kannur Town, Thalassery, Taliparamba, Payyannur, Mattannur, Iritty, Kuthuparamba, Panoor, Mahe, Chakkarakkal, Anjarakandy, and Thazhe Chovva, subject to slot availability.",
      },
      {
        q: "Can you attend urgent leakage or tripping issues on the same day?",
        a: "For common jobs like pipe leakage repair, motor issues, switchboard faults, MCB trips, and tap replacement, we try to offer same-day or next-available support in Kannur.",
      },
      {
  ...
  painting: {
    ...
    faqsEn: [
      ...
      },
      {
        ...
        a: "Yes. We support color selection based on light, room size, wall condition, and maintenance needs. This is especially useful for apartment painting and full-home repainting jobs in Kannur.",
      },
      {
  ...
  "appliance-servicing": {
    detailDescriptionEn:
      "Customers searching for AC service in Kannur, AC repair in Thalassery, washing machine repair near me, refrigerator repair, microwave repair, or water purifier service can book Ithihasam for doorstep appliance support across Kannur district. We diagnose cooling issues, unusual noise, drainage problems, startup failures, performance drops, and installation requirements for major household appliances with trained technicians and transparent job assessment.",
    faqsEn: [
      {
        q: "Which appliances do you service most often in Kannur?",
      ...
      },
      {
        ...
        a: "For many routine jobs, yes. Same-day support depends on technician routes, spare-part needs, and your location within Kannur or Taliparamba district.",
      },
      {
  ...
  carpentry: {
    ...
    faqsEn: [
      ...
      },
      {
        ...
        a: "Yes. Many bookings in Kannur involve wardrobe shutters, bed frames, cabinet hinges, drawer channels, and kitchen unit repairs rather than full replacement.",
      },
      {
        q: "Do you provide carpenter service for apartments and villas?",
        a: "Yes. Our carpentry work is suitable for apartments, villas, independent homes, offices, and small retail interiors across Kannur district.",
      },
      {
  ...
  "roofing-fabrication": {
    detailDescriptionEn:
      "Ithihasam supports customers searching for roofing sheet work in Kannur, roof repair in Mattannur, aluminium fabrication near me, steel fabrication, grill work, gate fabrication, truss work, and shed installation. We take up residential and commercial fabrication requirements for homes, terraces, shops, warehouses, and renovation sites across Kannur district with a focus on durability, fit, and clean finishing.",
    faqsEn: [
      {
      ...
      },
      {
        ...
        a: "Yes. We handle fabrication work for houses, villas, apartment common areas, workshops, retail shops, offices, and light commercial structures in Kannur.",
      },
      {
  ...
  "deep-cleaning": {
    ...
    faqsEn: [
      ...
      },
      {
        ...
        a: "Yes. In Kannur, many customers book kitchen deep cleaning, bathroom cleaning, or sofa shampooing as standalone services depending on the need.",
      },
      {
  ...
  "pest-control": {
    detailDescriptionEn:
      "Ithihasam provides pest control in Kannur for termite treatment, cockroach control, bed bug treatment, mosquito control, rodent control, and general pest management for homes, apartments, offices, and shops. The focus is on safe treatment planning, practical follow-up advice, and local scheduling for customers comparing pest control companies in Kannur district.",
    faqsEn: [
      {
        q: "Which pest control services are most commonly booked in Kannur?",
      ...
      },
      {
        ...
        a: "Yes. Termite treatment is one of the most requested services in Kannur district, especially for wardrobes, door frames, wooden fittings, and ground-level structures.",
      },
      {
  ...
  "smart-home": {
    detailDescriptionEn:
      "For customers searching for CCTV installation in Kannur, CCTV installation in Panoor, smart home setup near me, smart lock installation, Wi-Fi setup, or home automation service, Ithihasam provides practical security and connectivity upgrades for houses, flats, villas, offices, and shops. We help with camera placement, router planning, device integration, smart lighting, intercoms, and user-friendly setup based on the property layout.",
    faqsEn: [
      {
        q: "Do you provide CCTV installation for homes and small businesses?",
        a: "Yes. We support CCTV camera installation for houses, apartments, villas, shops, offices, clinics, and other small commercial properties across Kannur.",
      },
      {
      ...
      },
      {
        ...
        a: "In many cases, yes. Older homes in Kannur can often be upgraded with minimal rewiring depending on the device type and existing electrical layout.",
      },
      {
